        ...
        <div class="sidebar bg-success">
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item"><a href="students" class="nav-link text-uppercase font-weight-bold shadow-sm p-3  active"><i class="nav-icon fa fa-users"></i><p> My Students</p></a></li>
                ...
                <div class="card bg-white">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item" role="presentation">
                        <button class="nav-link text-uppercase border-right" id="payment-tab" data-toggle="tab" data-target="#payment" type="button" role="tab" aria-controls="payment" aria-selected="false">Payment History</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        ...
                        <div class="table-responsive">
                          <table id="zero_config" class="table table-sm table-bordered"> 
                            <tr> 
                              ...
                              <th rowspan="2" class="text-center p-4">Action</th> 
                            </tr> 
                            <tr> 
                            ...
                            <?php 
                              ...
                              while($row_syear = mysqli_fetch_array($syear_id)) {
                                ...
                                if(mysqli_num_rows($q_grades)<1) {
                                  echo "<tr>";
                                    echo "<td colspan='8' class='text-center'>No Grades added. <a href='schedule'>Manage grades here</a></td>";
                                  echo "</tr>";
                                }
                                else {
                                while($row_grades = mysqli_fetch_array($q_grades)) {
                                  ...
                                  while($row_stud_subj = mysqli_fetch_array($student_subject)) {
                                    echo "<tr>";
                                      ...
                                      echo "</td>";
                                      echo "<td><a href='#' data-toggle='modal' data-target='#StudentGrades".$row_grades['grID']."'><span class='badge bg-success rounded-pill'><i class='fas fa-pencil-alt text-dark p-1'></i> Update</span></a></td>";
                                    echo "</tr>";
                            ?>
                                    <div class="modal fade" id="StudentGrades<?php echo $row_grades['grID'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                          ...
                                          <div class="modal-body bg-white rounded m-2">
                                            <form class="add-new-post" id="enrollmentform" action="" method="post">
                                              <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-3">
                                                  <input type="number" name="first" class="form-control h5" id="first" value="<?php echo $row_grades['first'];?>" />
                                                  <input type="hidden" name="grid" class="form-control h5" id="grid" value="<?php echo $row_grades['grID'];?>" />
                                                  <input type="hidden" name="stid" class="form-control h5" id="grid" value="<?php echo $_GET['student_id'];?>" />
                                                  <input type="hidden" name="lrn" class="form-control h5" id="grid" value="<?php echo $_GET['lrnno'];?>" />
                                                </div>
                                              </div>
                                              <div class="mb-3 row">
                                                <label for="second" class="col-sm-3 text-end control-label col-form-label">Second Grading : </label>
                                                <div class="col-sm-3">
                                                  <input type="number" name="second" class="form-control h5" id="second" value="<?php echo $row_grades['second'];?>" />
                                                </div>
                                              </div>
                                              <div class="mb-3 row">
                                                <label for="third" class="col-sm-3 text-end control-label col-form-label">Third Grading : </label>
                                                <div class="col-sm-3">
                                                  <input type="number" name="third" class="form-control h5" id="third" value="<?php echo $row_grades['third'];?>" />
                                                </div>
                                              </div>
                                              <div class="mb-3 row">
                                                <label for="fourth" class="col-sm-3 text-end control-label col-form-label">Fourth Grading : </label>
                                                <div class="col-sm-3">
                                                  <input type="number" name="fourth" class="form-control h5" id="fourth" value="<?php echo $row_grades['fourth'];?>" />
                                                </div>
                                              </div>
                                              <div class="border-top">
                                                <div class="card-body">
                                                  <button type="submit" id="UpdateGrades" name="UpdateGrades" class="btn btn-primary"><i class="fa fa-check"></i> Modify Grade</button>
                                                </div>
                                              </div>
                                            </form>
                                          </div>
                                    ...
                                    while($row_history = mysqli_fetch_array($display_history)) {
                                      ...
                                      while($row_secname = mysqli_fetch_array($section_name)) {
                                        echo "<tr>";
                                          ...
                                          echo "</td>";
                                          echo "<td>";
                                            $grade_l = mysqli_query($conn, "SELECT * FROM $gradelevel WHERE glID='".$row_history['glevel']."'");

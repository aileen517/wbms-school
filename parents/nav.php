    ...
    <li class="nav-item">
      <a class="nav-link" href="message"><i class="far fa-comments"></i>
        <span class="badge badge-primary navbar-badge">
          <?php
            include("db_connect.php");
            $count_message = mysqli_query($conn, "SELECT * FROM $chatbx WHERE remarks='msg' AND toread='unread'  AND touser='".$_SESSION['SESS_STUDENT_LRN']."'");
    ...
    <li class="nav-item">
      <a class="nav-link" href="notification"><i class="far fa-bell"></i>
        <span class="badge badge-primary navbar-badge">
          <?php
            include("db_connect.php");
            $count_norify = mysqli_query($conn, "SELECT * FROM $chatbx WHERE remarks='notify' AND toread='unread' AND touser='All' LIMIT 10");

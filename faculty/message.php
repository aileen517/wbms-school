                                ...
                                <table id="zero_config" class="table table-striped h6">
                                  ...
                                  <tbody>
                                    <?php
                                        ...
                                        $msg_view = mysqli_query($conn, "SELECT * FROM $chatbx WHERE (touser='".$_SESSION['SESS_FACULTY_ID']."' and remarks='msg' AND scode='0') OR (tofrom='".$_SESSION['SESS_FACULTY_ID']."' and remarks='msg' AND scode='0')");
                          ...
                          <div class="card-body" style="height: 400px;">
                            <div class="direct-chat-messages" style="height: 400px;">
                              <?php
                                if(isset($_GET['msgid'])) {
                                  include("db_connect.php");
                                  //mysqli_query($conn, "UPDATE $chatbx SET toread='read' WHERE scode='".$_GET['msgid']."' AND touser='".$_SESSION['SESS_FACULTY_ID']."'");
                                  ...
                                  if(mysqli_num_rows($msg_info)>0) {
                                    while($row_msginfo = mysqli_fetch_array($msg_info)) {
                                      if($row_msginfo['tofrom']<>$_SESSION['SESS_FACULTY_ID']) {
                                  ...
                                  echo "Please click the sender name from your inbox to start conversation.";
                                }
                              ?>
                            </div>
                          </div>

<?php
	//Start session
	session_start();
	if(isset($_SESSION['SESS_FACULTY_ID']))
	{
		$aid=$_SESSION['SESS_FACULTY_ID'];
		include("db_connect.php");
		//mysqli_query($conn, "update $tbl_admin set status='0' where aID='$aid'") or die("not update");
		//Unset the variables stored in session
		unset($_SESSION['SESS_FACULTY_ID']);
		unset($_SESSION['SESS_FACULTY_LOGIN']);
		unset($_SESSION['SESS_FACULTY_PASSWD']);

        ...
        <div class="sidebar bg-success">
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item"><a href="enrollment" class="nav-link text-uppercase font-weight-bold shadow-sm p-3 active"><i class="nav-icon fa fa-user-plus"></i><p> Enrollment</p></a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card bg-white">
                            <div class="card-header">
                                <h5 class="card-title text-uppercase font-weight-bold"><i class="nav-icon fa fa-user-plus"></i> Enrollment Form</h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div id="myRadioGroup">
                                        ...
                                        <div id="twoCarDiv" class="desc">
                                            <form class="add-new-post" id="enrollmentform" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    <label for="etype" class="col-sm-3 text-end control-label col-form-label">Select LRN Type : </label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select name="dlearning" id="dlearning" class="form-control col-sm-6 h5">
                                        ...
                                        <div id="threeCarDiv" class="desc" style="width:1000px;">

                      ...
                      <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="col-sm-5 float-end mt-3">
                                <a href="print-reports?student_id=<?php echo $_GET['student_id'];?>&&lrnno=<?php echo $_GET['lrnno'];?>" onclick="NewWindow(this.href,'Analytics Report','900','650','no','center');return false" onfocus="this.blur()"><span class='badge badge-primary p-2'><i class="nav-icon fa fa-print"></i> Print Grades<span></a>
                              </div>
                            <div id='DivIdToPrint'>

                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="active dd-menu collapsed text-uppercase" href="announcement">Announcement</a>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="wow fadeInUp text-uppercase" data-wow-delay=".4s">Announcement</h2>
                     </div>
                </div>
            </div>
            <?php
                include("cnhsadmin/db_connect.php");
                $q_announce = mysqli_query($conn, "SELECT * FROM $about WHERE type='announce'"); 
                while($row_announce = mysqli_fetch_array($q_announce)) {
                    echo "<div class='row border-bottom'>";
                        echo "<div class='col-lg-12 col-md-12 col-12 bg-white p-4'>";
                            echo "<div class='content'>";
                                echo "<div class='top-content'>";
                                    echo "<img src='cnhsadmin/uploads/".$row_announce['photo']."' width='50'>";
                                    echo date("F d, Y", $row_announce['abtdate']);
                                echo "</div>";
                                echo "<div class='bottom-content'>";
                                     echo nl2br($row_announce['details']);
                                echo "</div>";
                            echo "</div>";
                        echo "</div>";
                    echo "</div>";

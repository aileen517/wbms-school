...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="active dd-menu collapsed text-uppercase" href="grade-level">Grade Level</a>
                                    </li>
                                    <li class="nav-item">
    ...
    <section class="why-choose section mt-70">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title glevel">
                        <h2 class="wow fadeInUp" data-wow-delay=".4s">Grade <?php echo $_GET['level'];?></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <?php
                                ...
                                if(mysqli_num_rows($procedure)>0) {
                                    while($row_proced = mysqli_fetch_array($procedure)) {
                                        echo nl2br($row_proced['details']);
                                    }
                                }
                                else {
                                    echo "No enrollment procedure found.";
                                }
                                mysqli_close($conn);
                            ?>
                        </div>

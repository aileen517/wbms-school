            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="wow fadeInUp text-uppercase" data-wow-delay=".4s">Terms of Use</h2>
                     </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 bg-white p-4">
                    <p>
                        <?php
                            include("cnhsadmin/db_connect.php");
                            $q_terms = mysqli_query($conn, "SELECT * FROM $about WHERE type='term'"); 
                            while($row_terms = mysqli_fetch_array($q_terms)) {
                                echo nl2br($row_terms['details']);
                            }
                            mysqli_close($conn);
                        ?>
                    </p>

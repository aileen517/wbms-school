                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="active dd-menu collapsed text-uppercase" href="javascript:void(0)"
                                            data-bs-toggle="collapse" data-bs-target="#submenu-1-3"
                                            aria-controls="navbarSupportedContent" aria-expanded="false"
                                            aria-label="Toggle navigation">About Us</a>
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            <li class="nav-item"><a href="history">History</a></li>
                                            <li class="nav-item active"><a href="mission">Mission</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="wow fadeInUp text-uppercase" data-wow-delay=".4s">Mission</h2>
                     </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 bg-white p-4">
                    <p>
                        <?php
                            include("cnhsadmin/db_connect.php");
                            $q_mission = mysqli_query($conn, "SELECT * FROM $about WHERE type='mis'"); 
                            while($row_mission = mysqli_fetch_array($q_mission)) {
                                echo nl2br($row_mission['details']);
                            }
                            mysqli_close($conn);
                        ?>
                    </p>

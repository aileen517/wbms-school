                ...
                <div class="card bg-white">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <?php
                        include("db_connect.php");
                        mysqli_query($conn, "UPDATE $chatbx SET toread='read' WHERE remarks='notify' AND toread='unread' AND touser='Admin'");
                        $notify_view = mysqli_query($conn, "SELECT * FROM $chatbx WHERE remarks='notify' AND touser='Admin'");

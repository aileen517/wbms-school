                ...
                <div class="card bg-white">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <?php
                        include("db_connect.php");
                        //mysqli_query($conn, "UPDATE $message SET fromread='read' WHERE tofrom='".$_SESSION['SESS_REGISTRAR_ID']."' and type='logs' AND fromread='unread'");
                        $notify_view = mysqli_query($conn, "SELECT * FROM $chatbx WHERE tofrom='".$_SESSION['SESS_REGISTRAR_ID']."' and remarks='logs'");

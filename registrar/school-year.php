                                  ...
                                  echo "<tr>";
                                    ...
                                    echo "<td>";
                                      if($row_syear['status']=="deactivated") {
                                        echo "<a href='?update=".$row_syear['syID']."'><span class='badge bg-success rounded-pill'><i class='fas fa-pencil-alt text-dark p-1'></i> Edit</span></a>  <a href='?activate=".$row_syear['syID']."'><span class='badge bg-info rounded-pill'><i class='fas fa-check text-dark p-1'></i> Activate</span></a>";
                                      }
                                      else {
                                        echo "<a href='?update=".$row_syear['syID']."'><span class='badge bg-success rounded-pill'><i class='fas fa-pencil-alt text-dark p-1'></i> Edit</span></a> <a href='?deactivate=".$row_syear['syID']."'><span class='badge bg-info rounded-pill'><i class='fas fa-times text-dark p-1'></i> Deactivate</span></a>";
                                      }
                                    echo "</td>";
                                  echo "</tr>";
                                }

                          ...
                          <tbody>
                            <?php
                              if(isset($_GET['q'])) {
                                include("db_connect.php");
                                $q = $_GET['q'];
                                $filter_student = mysqli_query($conn, "SELECT * FROM $student WHERE (sfname LIKE '%$q%' AND status='active') OR (slname LIKE '%$q%' AND status='active') OR (lrnno LIKE '%$q%' AND status='active') ORDER BY sfname ASC");

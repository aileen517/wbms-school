                            ...
                            <div class="direct-chat-messages" style="height: 463px;">
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        mysqli_query($conn, "UPDATE $chatbx SET fromread='read'  WHERE tofrom='".$_SESSION['SESS_REGISTRAR_ID']."'");
                                        mysqli_query($conn, "UPDATE $chatbx SET toread='read'  WHERE touser='".$_SESSION['SESS_REGISTRAR_ID']."'");
                                        $msg_view = mysqli_query($conn, "SELECT * FROM $chatbx WHERE (touser='".$_SESSION['SESS_REGISTRAR_ID']."' and remarks='msg' AND scode='0') OR (tofrom='".$_SESSION['SESS_REGISTRAR_ID']."' and remarks='msg' AND scode='0')");
                                        if(mysqli_num_rows($msg_view)<1) {
                                            echo "<h6>No message found.</h6>";
                                                ...
                                                while($row_msg_view = mysqli_fetch_array($msg_view)) {
                                                    echo "<h6>";
                                                        if($row_msg_view['touser']==$_SESSION['SESS_REGISTRAR_ID']){
                                                            ...
                                                            if(mysqli_num_rows($fromfaculty)>0) {
                                                                while($row_fromfaculty = mysqli_fetch_array($fromfaculty)) {
                                                                    echo "<div class='d-flex'>";
                                                                        echo "<div class='col-md-1 shadow-sm'><img src='../cnhsadmin/img/user_fac.png' width='40'></div>";
                                                                ...
                                                                if(mysqli_num_rows($fromstudent)>0) {
                                                                    while($row_fromstudent = mysqli_fetch_array($fromstudent)) {
                                                                        echo "<div class='d-flex'>";
                                                                            echo "<div class='col-md-1 shadow-sm'><img src='../cnhsadmin/img/user_stud.png' width='40'></div>";
                                                                            echo "<div class='col-md-11 shadow-sm'>";
                                                                    ...
                                                                    if(mysqli_num_rows($fromregistrar)>0) {
                                                                        while($row_fromregistrar = mysqli_fetch_array($fromregistrar)) {
                                                                            echo "<div class='d-flex'>";
                                                                                echo "<div class='col-md-1 shadow-sm'><img src='../cnhsadmin/img/user_reg.png' width='40'></div>";
                                                                                echo "<div class='col-md-11 shadow-sm'>";
                                                            ...
                                                            if(mysqli_num_rows($tofaculty)>0) {
                                                                ...
                                                                if(mysqli_num_rows($tostudent)>0) {
                                                                    ...
                                                                    if(mysqli_num_rows($toregistrar)>0) {
                                                                        ...
                                                                        $toadmin = mysqli_query($conn, "SELECT * FROM $admin WHERE admID='".$row_msg_view['touser']."'");
                                                                        if(mysqli_num_rows($toadmin)>0) {
                                                                        while($row_toadm = mysqli_fetch_array($toadmin)) {
                                                                            echo "<div class='d-flex'>";
                                                                                echo "<div class='col-md-1 shadow-sm'><img src='../cnhsadmin/img/user_adm.png' width='40'></div>";
                                                                                echo "<div class='col-md-11 shadow-sm'>";
                                                                                    echo "<li class='nav-item m-1'><a href='message?msgid=".$row_msg_view['chatID']."' class='text-decoration-none'> ".$row_toadm['fname']. " ".$row_toadm['lname']."</a></li>";
                                                                                    echo "<li class='nav-item m-1'>";
                                                                                        $msg_details = mysqli_query($conn, "SELECT * FROM $chatbx WHERE scode='".$row_msg_view['chatID']."' ORDER BY chatID DESC LIMIT 1");
                                                                                        if(mysqli_num_rows($msg_details)<1) {
                                                                                            $date1 = $row_msg_view['mdate']." ".$row_msg_view['mtime'];
                                ...
                                if(isset($_GET['msgid'])) {
                                  ...
                                  if(mysqli_num_rows($msg_info)>0) {
                                    while($row_msginfo = mysqli_fetch_array($msg_info)) {
                                        //print $_SESSION['SESS_REGISTRAR_ID'];
                                        if($row_msginfo['tofrom']<>$_SESSION['SESS_REGISTRAR_ID']) {
                                            print $_SESSION['SESS_REGISTRAR_ID'];
                                            echo "<div class='direct-chat-msg'>";
                                              ...
                                              echo "</div>";
                                                ...
                                                if(mysqli_num_rows($imgstudent)>0) {
                                                    echo "<img class='direct-chat-img' src='../cnhsadmin/img/user_stud.png' alt='message user image'>";
                                                }
                                                else {
                                                    $imgfaculty = mysqli_query($conn, "SELECT * FROM $faculty WHERE facode='".$row_msginfo['tofrom']."'"); 
                                                    if(mysqli_num_rows($imgfaculty)>0) {
                                                        echo "<img class='direct-chat-img' src='../cnhsadmin/img/user_fac.png' alt='message user image'>";
                                                    }
                                                    else {
                                                        $imgregistrar = mysqli_query($conn, "SELECT * FROM $registrar WHERE regcode='".$row_msginfo['tofrom']."'");
                                                        if(mysqli_num_rows($imgregistrar)>0) {
                                                            echo "<img class='direct-chat-img' src='../cnhsadmin/img/user_reg.png' alt='message user image'>";
                                                        }
                                                    }
                                                }

  ...
  <ul class="navbar-nav ml-auto">
      ...
      <a class="nav-link" href="message"><i class="far fa-comments"></i>
        <span class="badge badge-primary navbar-badge">
          <?php
            ...
            $count_message = mysqli_query($conn, "SELECT * FROM $chatbx WHERE remarks='msg' AND toread='unread' AND touser='".$_SESSION['SESS_REGISTRAR_ID']."'");
    ...
    <li class="nav-item">
      <a class="nav-link" href="notification"><i class="far fa-bell"></i>
        <span class="badge badge-primary navbar-badge">
          <?php
            include("db_connect.php");
            $count_norify = mysqli_query($conn, "SELECT * FROM $chatbx WHERE remarks='notify' AND touser='All'");
    ...
    <li class="nav-item dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="profile"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;Account Settings</a>

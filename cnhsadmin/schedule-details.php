                        ...
                        <table id="zero_config" class="table table-striped h6">
                          ...
                          <tbody>
                            <?php
                              ...
                              $display_schedule = mysqli_query($conn, "SELECT * FROM $schedule WHERE section_id='".$_GET['grade_level']."'");
                              if(mysqli_num_rows($display_schedule)<1) {
                                ...
                                while($row_schedule = mysqli_fetch_array($display_schedule)) {
                                  echo "<tr>";
                                    ...
                                    echo "<td>";
                                      if($row_schedule['faculty']=="") {
                                        echo "Not Assigned.";
                                      }
                                      else {
                                        $faculty12 = mysqli_query($conn, "SELECT * FROM $faculty WHERE facode='".$row_schedule['faculty']."'");
                                        while($row_faculty = mysqli_fetch_array($faculty12)) {

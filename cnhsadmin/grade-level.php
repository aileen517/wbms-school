            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card bg-white">
                  ...
                  <div class="card-body">
                    <div class="row">
                        <h5 class="bg-success rounded mb-1 col-md-12 d-flex">
                            <div class="col-md-9">
                                <a href="section?g_level_id=07" class="nav-link shadow-sm p-3 text-white"><i class="fa fa-bars nav-icon"></i>&nbsp;&nbsp;Grade 07</a>
                            </div>
                            <div class="col-md-3">
                                <ul class="nav">
                                    <li class="nav-item m-1"><a href="subject?level=07"><span class='badge bg-warning rounded-pill float-right mt-2 p-1'><i class='fas fa-plus p-1'></i> Subject</span></a></li>
                                    <li class="nav-item m-1"><a href="grade-details?level=07"><span class='badge bg-warning rounded-pill float-right mt-2 p-1'><i class='fas fa-plus p-1'></i> Description</span></a></li>
                                </ul>
                            </div>
                        </h5>
                        <h5 class="bg-info rounded mb-1 col-md-12 d-flex">
                            <div class="col-md-9">
                                <a href="section?g_level_id=08" class="nav-link shadow-sm p-3 text-white"><i class="fa fa-bars nav-icon"></i>&nbsp;&nbsp;Grade 08</a>
                            </div>
                            <div class="col-md-3">
                                <ul class="nav">
                                    <li class="nav-item m-1"><a href="subject?level=08"><span class='badge bg-danger rounded-pill float-right mt-2 p-1'><i class='fas fa-plus p-1'></i> Subject</span></a></li>
                                    <li class="nav-item m-1"><a href="grade-details?level=08"><span class='badge bg-danger rounded-pill float-right mt-2 p-1'><i class='fas fa-plus p-1'></i> Description</span></a></li>
                                </ul>
                            </div>
                        </h5>
                        <h5 class="bg-warning rounded mb-1 col-md-12 d-flex">
                            <div class="col-md-9">
                                <a href="section?g_level_id=09" class="nav-link shadow-sm p-3 text-white"><i class="fa fa-bars nav-icon"></i>&nbsp;&nbsp;Grade 09</a>
                            </div>
                            <div class="col-md-3">
                                <ul class="nav">
                                    <li class="nav-item m-1"><a href="subject?level=09"><span class='badge bg-success rounded-pill float-right mt-2 p-1'><i class='fas fa-plus p-1'></i> Subject</span></a></li>
                                    <li class="nav-item m-1"><a href="grade-details?level=09"><span class='badge bg-success rounded-pill float-right mt-2 p-1'><i class='fas fa-plus p-1'></i> Description</span></a></li>
                                </ul>
                            </div>
                        </h5>
                        <h5 class="bg-danger rounded mb-1 col-md-12 d-flex">
                            <div class="col-md-9">
                                <a href="section?g_level_id=10" class="nav-link shadow-sm p-3 text-white"><i class="fa fa-bars nav-icon"></i>&nbsp;&nbsp;Grade 10</a>
                            </div>
                            <div class="col-md-3">
                                <ul class="nav">
                                    <li class="nav-item m-1"><a href="subject?level=10"><span class='badge bg-info rounded-pill float-right mt-2 p-1'><i class='fas fa-plus p-1'></i> Subject</span></a></li>
                                    <li class="nav-item m-1"><a href="grade-details?level=10"><span class='badge bg-info rounded-pill float-right mt-2 p-1'><i class='fas fa-plus p-1'></i> Description</span></a></li>
                                </ul>
                            </div>
                        </h5>
                    </div>

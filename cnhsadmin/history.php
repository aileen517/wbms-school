            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item"><a href="#" class="nav-link text-uppercase font-weight-bold shadow-sm p-3 active"><i class="nav-icon fa fa-info-circle"></i><p> About Us<i class="fas fa-angle-left right"></i></p></a>
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item"><a href="history" class="nav-link text-uppercase font-weight-bold shadow-sm active"><i class="fa fa-history nav-icon fs-8"></i><p> History</p></a></li>
              ...
              <div class="col-md-12">
                <div class="card bg-white">
                  <div class="card-header">
                    <i class="fa fa-history nav-icon fs-8"></i> Manage History
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <form class="form col-md-12 h6" method="post" action="">
                        <?php
                          include("db_connect.php");
                          $q_his = mysqli_query($conn, "SELECT * FROM $about WHERE type='his'");
                          if(mysqli_num_rows($q_his)>0) {
                            while($row_his = mysqli_fetch_array($q_his)) {
                        ?>
                              <div class="mb-3 row">
                                <label for="details" class="col-sm-3 text-end control-label col-form-label">Details : </label>
                                <div class="col-lg-12">
                                  <textarea name="details" id="details" cols="300" rows="15" class="form-control" style="resize: none;"><?php echo $row_his['details'];?></textarea>
                                  <input type="hidden" name="abid" class="form-control h6" id="abid" required value="<?php echo $row_his['abID'];?>" />
                                </div>
                              </div>
                              <div class="mb-3 row">
                                <button type="submit" name="UpdateHistory" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Update History</button>
                              </div>
                        <?php
                            }
                          }
                        ...
                        ?>
                            ...
                            <div class="mb-3 row">
                              <button type="submit" name="SubmitHistory" class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i> Add History</button>
                            </div>
                        <?php
                          } 
                          mysqli_close($conn);

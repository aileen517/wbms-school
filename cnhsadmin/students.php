                                  ...
                                  while($row_fstudent = mysqli_fetch_array($filter_student)) {
                                    ...
                                    while($row_filter_secname = mysqli_fetch_array($filter_section_name)) {
                                      echo "<tr>";
                                        ...
                                        echo "<td>";
                            ?>
                                        <a href="student-chart?lrnno=<?php echo $row_student['lrnno'];?>" onclick="NewWindow(this.href,'Analytics Report','900','650','no','center');return false" onfocus="this.blur()"><i class='fa fa-signal text-success p-1'></i></a> <a href='students?deactivate=<?php echo $row_student['lrnno'];?>'><i class='fa fa-times text-danger p-1'></i> </a>
                            <?php
                                      echo "</td>";
                                      echo "</tr>";
                                    }
                                ...
                                include("db_connect.php");
                                $display_student = mysqli_query($conn, "SELECT * FROM $student WHERE status='active' ORDER BY glevel ASC");

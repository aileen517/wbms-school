                              ...
                              <div class="table-responsive col-md-6">
                                <form method="post" action="">
                                  <table id="zero_config" class="table table-striped h6 mt-2">
                                    <?php
                                      include("db_connect.php");
                                      $profile = mysqli_query($conn, "SELECT * FROM $admin WHERE admID='".$_SESSION['SESS_ADMIN_ID']."'");
                                      while($row_student = mysqli_fetch_array($profile)) {
                                        ...
                                        echo "<tr>";
                                          ...
                                          echo "<td>:</td>";
                                          echo "<td><input name='fname' type='text' class='form-control' value='".$row_student['lname']."'></td>";
                                        echo "</tr>";
                                        echo "<tr>";
                                          echo "<td>Contact</td>";
                                          echo "<td>:</td>";
                                          echo "<td><input name='con' type='number' class='form-control' value='".$row_student['contact']."'></td>";
                                        echo "</tr>";
                                        echo "<tr>";
                                          echo "<td>Email</td>";
                                          echo "<td>:</td>";
                                        ...
                                        echo "<tr>";
                                          echo "<td>Address</td>";
                                          echo "<td>:</td>";
                                          echo "<td><input name='addr' type='text' class='form-control' value='".$row_student['addr']."'><input name='aid' type='hidden' class='form-control' value='".$row_student['admID']."'><button type='submit' name='UpdateProfile' class='btn btn-primary mt-1'>Update</button></td>";
                                        echo "</tr>";
                                     }
                                      mysqli_close($conn);
                                    ?>
                                    ...
                                    <?php
                                      ...
                                      while($row_student = mysqli_fetch_array($profile)) {
                                        echo "<tr>";
                                          echo "<td>Username</td>";
                                          echo "<td>:</td>";
                                          echo "<td>".$row_student['usern']."</td>";
                                        echo "</tr>";
                                        echo "<tr>";
                                          echo "<td>Old Password</td>";
                                          echo "<td>:</td>";
                                          echo "<td><input name='oldpassw' type='password' class='form-control' value='".$row_student['passw']."' id='id_password'><i class='far fa-eye float-right text-white' id='togglePassword' style='margin-top: -30px; margin-left:220px; position:absolute; cursor: pointer;'></i></td>";
                                        echo "</tr>";
                                        echo "<tr>";

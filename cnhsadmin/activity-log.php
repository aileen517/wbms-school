              ...
              <div class="col-md-12">
                <div class="card bg-white">
                  <div class="card-header">
                    <div class="d-flex">
                      <div class="col-sm-6">
                        <i class="far fa-bell"></i> Activity List
                      </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <?php
                        ...
                        //mysqli_query($conn, "UPDATE $message SET toread='read' WHERE touser='".$_SESSION['SESS_ADMIN_ID']."' and type='notify' AND toread='unread'");
                        $logs_view = mysqli_query($conn, "SELECT * FROM $chatbx WHERE remarks='logs'");
                        if(mysqli_num_rows($logs_view)<1) {
                      ?>
                      ...
                      <?php
                          ...
                          while($row_logs_view = mysqli_fetch_array($logs_view)) {
                            echo "<div class='direct-chat-msg col-md-12'>";
                              echo "<div class='direct-chat-infos clearfix'>";
                                echo "<span class='direct-chat-timestamp float-right'>";
                                  echo date("m/d/Y", $row_logs_view['mdate'])." ".date("h:i A", $row_logs_view['mtime']);
                                echo "</span>";
                              echo "</div>";
                              echo "<img class='direct-chat-img' src='img/user_adm.png' alt='message user image'>";
                              echo "<div class='direct-chat-text'>";
                                echo $row_logs_view['details'];
                              echo "</div>";
                            echo "</div>";
                          }
                        }

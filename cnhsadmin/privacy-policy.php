              ...
              <div class="col-md-12">
                <div class="card bg-white">
                  <div class="card-header">
                    <h5 class="card-title text-uppercase font-weight-bold"><i class="nav-icon fa fa-bullhorn"></i> Manage Privacy Policy</h5>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <form class="form col-md-12 h6" method="post" action="" enctype="multipart/form-data">
                        <?php
                          include("db_connect.php");
                          $q_about = mysqli_query($conn, "SELECT * FROM $about WHERE type='privacy'");
                          if(mysqli_num_rows($q_about)>0) {
                        ...
                        ?>
                              ...
                              <div class="mb-3 row">
                                <button type="submit" name="UpdatePolicy" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Update Privacy Policy</button>
                              </div>
                        <?php
                              mysqli_close($conn);
                            }
                        ...
                        ?>
                            ...
                            <div class="mb-3 row">
                              <button type="submit" name="SubmitPolicy" class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i> Add Privacy Policy</button>
                            </div>
                        <?php
                          } 
                        ?>

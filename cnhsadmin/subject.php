            ...
            <div class="row mb-2">
              <div class="col-sm-6">
                <ol class="breadcrumb text-uppercase">
                  ...
                  <li class="breadcrumb-item">Grade Level</li>
              ...
              <div class="col-md-12">
                <div class="card bg-white">
                  <div class="card-header">
                    <h5 class="card-title text-uppercase font-weight-bold"><i class="nav-icon fa fa-bars"></i><?php echo "Grade ".$_GET['level']." Subject";?></h5>
                  </div>
                  <div class="card-body">
                    <div class="row">

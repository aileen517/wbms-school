        ...
        <div class="sidebar bg-success">
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item"><a href="announcement" class="nav-link text-uppercase font-weight-bold shadow-sm p-3 active"><i class="nav-icon fa fa-bullhorn"></i><p> Announcement</p></a></li>
              ...
              <div class="col-md-12">
                <div class="card bg-white">
                  <div class="card-header">
                    <h5 class="card-title text-uppercase font-weight-bold"><i class="nav-icon fa fa-bullhorn"></i> New Announcement</h5>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <form class="form col-md-12 h6" method="post" action="" enctype="multipart/form-data">
                        ...
                        ?>
                            ...
                            <div class="mb-3 row">
                              <button type="submit" name="SubmitAnnounce" class="btn btn-primary"><i class="fa fa-plus-square" aria-hidden="true"></i> Add Announcement</button>
                            </div>
                        <?php
                          } 
                        ?>
                        ...
                        <table id="zero_config" class="table table-striped h6">
                          ...
                          <tbody>
                            <?php
                              ...
                              $display_announce = mysqli_query($conn, "SELECT * FROM $about WHERE type='announce'");
                              if(mysqli_num_rows($display_announce)<1) {
                                ...
                                while($row_announce = mysqli_fetch_array($display_announce)) {
                                  echo "<tr>";
                                    ...
                                    echo "<td><a href='?update=".$row_announce['abID']."'><span class='badge bg-success rounded-pill'><i class='fas fa-pencil-alt text-dark p-1'></i> Edit</span></a> <a href='?delete_announcement=".$row_announce['abID']."'><span class='badge bg-danger rounded-pill'><i class='fas fa-trash text-dark p-1'></i> Delete</span></a></td>";
                                  echo "</tr>";
                                }
                              }
                              mysqli_close($conn);

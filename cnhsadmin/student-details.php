                ...
                <div class="card bg-white">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item" role="presentation">
                        <button class="nav-link text-uppercase border-right" id="report-tab" data-toggle="tab" data-target="#report" type="button" role="tab" aria-controls="report" aria-selected="false">Report Card</button>
                      </li>
                      <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <tbody>
                              <?php
                                ...
                                while($row_stud = mysqli_fetch_array($student_q)) {
                                  $display_schedule = mysqli_query($conn, "SELECT * FROM $schedule WHERE section_id='".$row_stud['section']."'");
                      ...
                      <div class="tab-pane fade bordered" id="upload" role="tabpanel" aria-labelledby="upload-tab">
                            ...
                            <table id="zero_config" class="table table-striped h6">
                                <thead>
                                    <tr>
                                        <th class="fw-bold">Requirements Uploaded</th>
                                    ...
                                    <?php
                                        if(isset($_GET['lrnno'])) {
                                            ...
                                            while($row_req = mysqli_fetch_array($q_req)) {
                                                echo "<tr>";
                                                    echo "<td>".$row_req['req']."</td>";
                                                    echo "<td><a href='?download=".$row_req['req']."'><i class='fa fa-download'></i> download</a></td>";
                                            }
                                            mysqli_close($conn);
                                        }
                                    ?>

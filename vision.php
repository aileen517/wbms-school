                                ...
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="sub-menu collapse" id="submenu-1-3">
                                            ...
                                            <li class="nav-item active"><a href="vision">Vision</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="wow fadeInUp text-uppercase" data-wow-delay=".4s">Vision</h2>
                     </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 bg-white p-4">
                    <p>
                        <?php
                            include("cnhsadmin/db_connect.php");
                            $q_vision = mysqli_query($conn, "SELECT * FROM $about WHERE type='vis'"); 
                            while($row_vision = mysqli_fetch_array($q_vision)) {
                                echo nl2br($row_vision['details']);
                            }
                            mysqli_close($conn);
                        ?>
                    </p>

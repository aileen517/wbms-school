            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="wow fadeInUp text-uppercase" data-wow-delay=".4s">History</h2>
                     </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 bg-white p-4">
                    <p>
                        <?php
                            include("cnhsadmin/db_connect.php");
                            $q_history = mysqli_query($conn, "SELECT * FROM $about WHERE type='his'"); 
                            while($row_history = mysqli_fetch_array($q_history)) {
                                echo nl2br($row_history['details']);
                            }
                            mysqli_close($conn);
                        ?>
                    </p>

            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="wow fadeInUp text-uppercase" data-wow-delay=".4s">Privacy Policy</h2>
                     </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12 bg-white p-4">
                    <p>
                        <?php
                            include("cnhsadmin/db_connect.php");
                            $q_privacy = mysqli_query($conn, "SELECT * FROM $about WHERE type='privacy'"); 
                            while($row_privacy = mysqli_fetch_array($q_privacy)) {
                                echo nl2br($row_privacy['details']);
                            }
                            mysqli_close($conn);
                        ?>
                    </p>
